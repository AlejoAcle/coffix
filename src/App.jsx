...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-primary">
        ...
        <footer className='container mx-auto p-6 flex flex-col md:flex-row items-center justify-between font-black'>

          <p >Build with <box-icon name='bowl-hot' rotate='90' animation='tada' color='#3d1e0a' ></box-icon> by Alejo </p>
          
          <div className='flex -mx-6'>
              <a href='#' className='font-black mx-3 hover:opacity-80 duration-150'> About us</a>
              <a href='#' className='font-black mx-3 hover:opacity-80 duration-150'> Privacy</a>
              <a href='#' className='font-black mx-3 hover:opacity-80 duration-150'> Contact</a>
